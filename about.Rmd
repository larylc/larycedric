...
<p  class= "normal-text">I am a data analyst working @ Story Planet.</p>

<p class= "normal-text">I started learning how to code while earning my BA in Biology and Education at Swarthmore College. I took a more serious interest in data science and became a DataCamp certified <a href= "https://www.datacamp.com/certificate/DA0022682718788"><span class= "bolded-text"> Professional Analyst</span></a>.</p>

<p  class= "normal-text">I am really interested in information design, data journalism and storytelling, and business intelligence</p>
...
<p><span class= "stat-num">3</span> <span class= "stat-text"> DataCamp Tracks</span></p>
<p><span class= "stat-num">37</span><span class= "stat-text"> DataCamp Courses</span></p>
<p><span class= "stat-num">160</span><span class= "stat-text"> DataCamp Hours</span></p>
</div>
